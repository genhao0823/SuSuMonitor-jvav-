---
name: kotlin-coding
description: Kotlin 编码规范。当在 SuSuMonitor 项目目录下编写 Android/Kotlin 代码时使用。触发场景包括：(1) 编写 Kotlin 代码，(2) 使用 Jetpack Compose 编写 UI，(3) 使用 Retrofit 网络请求，(4) Android 前台 Service 开发，(5) Android 推送通知。
---
